...
|속성|영문명칭|설명|비고|
|:----:|:----:|:----:|:----:|
|종류|maze_Type|미로는 계절별로 존재하며 스테이지를 나누는 종류의 개념으로 사용된다.|-|
...
- 시작버튼 클릭 시 기존 4개의 버튼은 사라지고 플레이어1인지 플레이어2인지 선택 할 수 있는 버튼과 자신의 이름을 입력할 수 있는 곳이 있다.
- 자신의 이름을 입력하고 플레이어1 또는 플레이어2 클릭시 각자의 게임화면으로 넘어간다.
